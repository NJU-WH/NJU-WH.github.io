...
var btf = {
    ...
    throttle: function(n, r, o) {
        ...
        return function() {
            ...
            a = this,
            s = arguments,
            t <= 0 || r < t ? (i && (clearTimeout(i),
            i = null),
            u = e,
            n.apply(a, s),
            i || (a = s = null)) : i || !1 === o.trailing || (i = setTimeout(l, t))
        }
    },
    ...
    snackbarShow: function(e, t, n) {
        ...
        document.styleSheets[0].addRule(":root", "--heo-snackbar-time:" + o + "ms!important"),
        Snackbar.show({
            text: e,
            backgroundColor: a,
            showAction: r,
    ...
    diffDate: function(e, t) {
        var n, r, o, i = 1 < arguments.length && void 0 !== t && t, a = new Date, s = new Date(e), u = a.getTime() - s.getTime();
        return i ? (n = u / 864e5,
        r = u / 36e5,
        o = u / 6e4,
        12 < u / 2592e6 ? s.toLocaleDateString() : 7 <= n ? s.toLocaleDateString().substr(5) : 1 <= n ? parseInt(n) + "" + GLOBAL_CONFIG.date_suffix.day : 1 <= r || 1 <= o ? "最近" : GLOBAL_CONFIG.date_suffix.just) : parseInt(u / 864e5)
    },
    ...
    scrollToDest: function(o, i) {
        var a, s;
        o < 0 || i < 0 || (a = window.scrollY || window.screenTop,
        o -= 70,
        "CSS"in window && CSS.supports("scroll-behavior", "smooth") ? window.scrollTo({
            top: o,
            behavior: "smooth"
        }) : (s = null,
        i = i || 500,
        window.requestAnimationFrame(function e(t) {
            ...
            n < i ? window.requestAnimationFrame(e) : window.scrollTo(0, o)) : (r = t - s,
            window.scrollTo(0, a - (a - o) * r / i),
            r < i ? window.requestAnimationFrame(e) : window.scrollTo(0, o))
        })))
    },
    fadeIn: function(e, t) {
